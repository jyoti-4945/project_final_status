...
@EnableTransactionManagement   
	...
	//to create beans
		...
		public SessionFactory sessionFactory() {
			...
			Class classes[]=new Class[]{Product.class,Category.class,Customer.class,User.class,BillingAddress.class,ShippingAddress.class,Authorities.class}; //If product class is not yet created, remove this and add it later
